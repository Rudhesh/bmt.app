            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <a href="#" className="font-semibold text-indigo-600 hover:text-[#303f57]">
                    Forgot password?
                  </a>
                </div>
              </div>
              <div className="mt-2">
                <input
                  ...
                  required
                  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#303f57] sm:text-sm sm:leading-6"
                />
              </div>
            </div>
